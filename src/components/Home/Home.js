        ...
        <section id="profile">
            <div className="profile__container">
                <div className="section__text">
                    ...
                    <h1> A passionate Junior Software Developer and Digital Illustrator
                    ...
                    <div className="social-icons">
                        <img src={linkedinIcon} alt="LinkedIn" width="50" className="linkedin-icon"/>
                        <img src={behanceIcon} alt="BehanceIcon" width="50" className="behance-icon"/>
                        <img src={githubIcon} alt="githubIcon" width="50" className="github-icon"/>
                    </div>
                </div>
